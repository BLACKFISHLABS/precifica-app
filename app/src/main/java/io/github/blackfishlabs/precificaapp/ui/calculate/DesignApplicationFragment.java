...
public class DesignApplicationFragment extends BaseFragment implements Step {
    ...
    LinearLayout op1;
    @BindView(R.id.quest_answer_3_1)
    TextView answer1;

    @BindView(R.id.option_3_2)
    LinearLayout op2;
    @BindView(R.id.quest_answer_3_2)
    TextView answer2;

    @BindView(R.id.option_3_3)
    LinearLayout op3;
    @BindView(R.id.quest_answer_3_3)
    TextView answer3;

    @BindView(R.id.option_3_4)
    LinearLayout op4;
    @BindView(R.id.quest_answer_3_4)
    TextView answer4;
    ...
    private static final String QUESTION_ID = "3";

    public static DesignApplicationFragment newInstance() {
        return new DesignApplicationFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle inState) {
        ...
        op3.setOnClickListener(v -> {
            changeQuestion(op3, Lists.newArrayList(op1, op2, op4));
            selectedItem = new Question(QUESTION_ID,
                    question3.getText().toString(),
                    answer1.getText().toString(), 500.00);
        });
        ...
        op4.setOnClickListener(v -> {
            changeQuestion(op4, Lists.newArrayList(op1, op2, op3));
            selectedItem = new Question(QUESTION_ID,
                    question3.getText().toString(),
    ...
    protected int provideContentViewResource() {
        return R.layout.fragment_design_app;
    }
}
