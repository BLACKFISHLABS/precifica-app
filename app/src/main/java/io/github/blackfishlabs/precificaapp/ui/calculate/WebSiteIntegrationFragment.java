...
public class WebSiteIntegrationFragment extends BaseFragment implements Step {

    @BindView(R.id.option_6_1)
    LinearLayout op1;
    @BindView(R.id.quest_answer_6_1)
    TextView answer1;

    @BindView(R.id.option_6_2)
    LinearLayout op2;
    @BindView(R.id.quest_answer_6_2)
    TextView answer2;

    @BindView(R.id.option_6_3)
    LinearLayout op3;
    @BindView(R.id.quest_answer_6_3)
    TextView answer3;
    ...
    private static final String QUESTION_ID = "6";

    public static WebSiteIntegrationFragment newInstance() {
        return new WebSiteIntegrationFragment();
    }
    ...
    protected int provideContentViewResource() {
        return R.layout.fragment_website_integration;
    }
}
