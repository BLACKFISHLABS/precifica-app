...
public class LoginApplicationFragment extends BaseFragment implements Step {

    @BindView(R.id.option_5_1)
    LinearLayout op1;
    @BindView(R.id.quest_answer_5_1)
    TextView answer1;

    @BindView(R.id.option_5_2)
    LinearLayout op2;
    @BindView(R.id.quest_answer_5_2)
    TextView answer2;

    @BindView(R.id.option_5_3)
    LinearLayout op3;
    @BindView(R.id.quest_answer_5_3)
    TextView answer3;

    @BindView(R.id.option_5_4)
    LinearLayout op4;
    @BindView(R.id.quest_answer_5_4)
    TextView answer4;
    ...
    private static final String QUESTION_ID = "5";

    public static LoginApplicationFragment newInstance() {
        return new LoginApplicationFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle inState) {
        ...
        op1.setOnClickListener(v -> {
            ...
            selectedItem = new Question(QUESTION_ID,
                    ...
                    answer1.getText().toString(), 1500.00);
        });
        ...
        op2.setOnClickListener(v -> {
            ...
            selectedItem = new Question(QUESTION_ID,
                    question5.getText().toString(),
                    answer2.getText().toString(), 500.00);
        });
