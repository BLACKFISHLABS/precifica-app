...
public class QualityLevelFragment extends BaseFragment implements Step {

    @BindView(R.id.option_1_1)
    LinearLayout op1;
    @BindView(R.id.quest_answer_1_1)
    TextView answer1;

    @BindView(R.id.option_1_2)
    LinearLayout op2;
    @BindView(R.id.quest_answer_1_2)
    TextView answer2;

    @BindView(R.id.option_1_3)
    LinearLayout op3;
    @BindView(R.id.quest_answer_1_3)
    TextView answer3;
    ...
    public static QualityLevelFragment newInstance() {
        return new QualityLevelFragment();
    }
