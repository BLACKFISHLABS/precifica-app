...
public class ProjectStatusFragment extends BaseFragment implements Step {

    @BindView(R.id.option_10_1)
    LinearLayout op1;
    @BindView(R.id.quest_answer_10_1)
    TextView answer1;

    @BindView(R.id.option_10_2)
    LinearLayout op2;
    @BindView(R.id.quest_answer_10_2)
    TextView answer2;

    @BindView(R.id.option_10_3)
    LinearLayout op3;
    @BindView(R.id.quest_answer_10_3)
    TextView answer3;

    @BindView(R.id.option_10_4)
    LinearLayout op4;
    @BindView(R.id.quest_answer_10_4)
    TextView answer4;

    @BindView(R.id.question_10)
    TextView question10;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle inState) {
        ...
        op1.setOnClickListener(v -> {
            ...
            selectedItem = new Question(QUESTION_ID,
                    question10.getText().toString(),
                    answer1.getText().toString(), 100.00);
        });
        ...
        op3.setOnClickListener(v -> {
            ...
            selectedItem = new Question(QUESTION_ID,
                    question10.getText().toString(),
                    answer3.getText().toString(), -500.00);
        });
        ...
        op4.setOnClickListener(v -> {
            ...
            selectedItem = new Question(QUESTION_ID,
                    question10.getText().toString(),
                    answer4.getText().toString(), -1000.00);
        });
